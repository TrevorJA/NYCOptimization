...
severity `downstream_flood_severity_minor` ADOPTED 2026-08-03 in place of the
...
- [ ] **[HPC]** Re-run the epsilon calibration (3 designs, ~57 SU) + framing
  ...
  FINAL ε for the new `downstream_flood_severity_annual` objective (shipped
