...
# Generated by the workflow/01-03 ensemble pipeline (scripts/main/
# {generate_stochastic_ensemble,subsample_lhs_ensemble,prep_pywrdrb_inputs}.py);
...
# per-ensemble via slurm/envs/ensemble_kn_*.env so a single shell submission
