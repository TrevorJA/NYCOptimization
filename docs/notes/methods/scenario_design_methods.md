...
| Re-evaluation on E_test | 66 SU per policy measured, 2,000-policy cap | ~132k |
| Draw-sensitivity re-evaluation (SI) | d1, d2 at $N = 300$ | ~1k |
| **Campaign total** | | **~489–544k** |
| **Reserve against the ~600k balance** | | **~56–111k** |
